export default {
  ...
  keys: {
    ...
    ccsEndpointSelect: {
      title: 'Select CCS Endpoint',
      description: 'Use the compatible endpoint for this key group by default, or choose a custom endpoint configured for this site.',
      defaultCompatible: 'Default Compatible Endpoint',
      defaultHint: 'Generated from the API key group platform so the client can start without extra config changes.',
      importDefault: 'Import with Default Endpoint',
      customTitle: 'Custom Endpoint',
      customHint: 'Use this for reverse proxies, alternate routes, or extra endpoints configured by the admin.',
      useThis: 'Use this endpoint',
      manualEndpoint: 'Manual endpoint',
      manualPlaceholder: 'https://api.example.com/v1',
      importCustom: 'Import with Custom Endpoint',
    },
  ...
  admin: {
    ...
    accounts: {
      ...
      cliproxyAuthImportSuccess: 'Import completed: created {account_created}, replaced {account_replaced}, skipped {account_skipped}',
      ...
      cliproxyAuthImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, replaced {account_replaced}, skipped {account_skipped}, failed {account_failed}',
      cliproxyAuthDuplicateTitle: 'Duplicate CLIProxyAPI Auths Detected',
      cliproxyAuthDuplicateMessage: 'Found {count} imported account(s) that match existing accounts. You can keep the existing accounts and skip duplicates, or replace the existing accounts with the imported auth data.',
      cliproxyAuthDuplicateSourceFile: 'Source file: {file}',
      cliproxyAuthDuplicateExisting: 'Existing account: {name} (ID: {id}), matched by {matchedBy}',
      cliproxyAuthDuplicateKeepExisting: 'Skip Duplicates',
      cliproxyAuthDuplicateReplaceExisting: 'Replace Existing',
      cliproxyAuthDuplicateMatchBy: {
      ...
      openai: {
        baseUrlHint: 'Leave default for official OpenAI API, or point it to an OpenAI-compatible provider base URL.',
        apiKeyHint: 'Your OpenAI API Key, or the API key issued by a compatible provider.',
        compatTitle: 'OpenAI-Compatible Provider (Optional)',
        compatDescription: 'OpenAI API Key accounts now support OpenAI-compatible providers. Point Base URL to the compatible endpoint, then optionally add a provider label and custom headers here.',
        providerName: 'Provider Name',
        providerNamePlaceholder: 'e.g. OpenRouter, Together, Groq',
        providerNameHint: 'For admin-side identification only; it is not used for request signing.',
        customHeaders: 'Custom Headers',
        customHeadersPlaceholder: '{\n  \"HTTP-Referer\": \"https://example.com\",\n  \"X-Title\": \"sub2api\"\n}',
        customHeadersHint: 'Enter a JSON object. Useful for extra headers required by providers such as OpenRouter.',
        customHeadersInvalid: 'Custom headers must be a valid JSON object with string values.',
